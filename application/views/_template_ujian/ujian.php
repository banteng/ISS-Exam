...
?>
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						<div class="col-sm-4 bf-kri">
							<a class="action btn back btn-warning"><i class="fa fa-chevron-left"></i> PREVIOUS</a>
						</div>
						<div class="col-sm-4 bf-tengah">
							<a class="action btn simpan btn-default">SAVE</a>
						</div>
						<div class="col-sm-4 bf-kanan">
							<a class="action btn next btn-warning">NEXT <i class="fa fa-chevron-right"></i></a>
						</div>
						<div class="col-sm-4 bf-kanan">
							<a class="action submit btn btn-success"><i class="fa fa-check"></i> FINISH</a>
						</div>
					</div>
			...
			<div class="col-sm-3">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h4 class="box-title">Remaining time</h4>
					</div>
					<div class="box-body">
						<div class="waktu bg-blue" id="clock"></div>
					</div>
					<div class="box-footer">
						<a class="btn btn-selesai btn-block btn-danger">Finish</a>
					</div>
				</div>
			</div>
		...
		<script>
			...
			simpan_akhir = function(id){
				if (confirm('Are you sure want to end this question ?')) {
					var f_asal = $('#_form');
					var form = getFormData(f_asal);
